...
As notas individuais de lacunas baseadas em YAML estão centralizadas em [[HUB_Lacunas_Projeto.base]]. As tabelas originais permanecem como o registro-fonte consolidado; as notas fornecem registros no nível de propriedades para filtragem, agrupamento e vinculação a tarefas no Obsidian Bases.
