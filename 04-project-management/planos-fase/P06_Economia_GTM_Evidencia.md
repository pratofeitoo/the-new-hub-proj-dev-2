...
|---|---|---|
| Registro premissas (com confiança + proveniência) | `01-work/dados-tech-financas/modelos-financeiros/` + `05-resources/planilhas/` | refining |
| Modelo financeiro reconciliado (3 cenários) | mesmo + `01-work/dados-tech-financas/modelos-financeiros/` | refining |
