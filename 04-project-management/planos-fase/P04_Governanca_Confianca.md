...
bp_tasks:
  - BP-006
related_notes:
  - "[[01-work/governanca-juridico/HUB_Blueprint_Governanca_e_Juridico]]"
...
|---|---|---|
| Matriz entidades + acordos intragrupo | `01-work/governanca-juridico/` + `01-work/documentos-oficiais/_controle/` | blueprint→refining |
| Mapa governança dados fluxo a fluxo | mesmo | refining |
| Carta independência Selo + controles operacionais | mesmo + `01-work/governanca-juridico/` | refining |
| Matriz responsabilidade + seguros | mesmo | refining |
| Registro PI + acordos | mesmo | refining |
| RACI v2 + matriz direitos decisão | `01-work/governanca-juridico/` + `00-project-control/registro-lacunas/lacunas/GOV-008.md` | refining |
