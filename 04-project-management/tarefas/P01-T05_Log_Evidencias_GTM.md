...
dependencies:
  - P01-T04
target_file: 01-work/pesquisa/log-evidencias-GTM.md
related_notes:
...
## Entregável
Arquivo `log-evidencias-GTM.md` em `01-work/pesquisa/` com colunas: rota, parceiro, status, evidência, link, fallback.
...
- **Entregável produzido:** [[01-work/pesquisa/log-evidencias-GTM|log de evidências GTM]] com sete rotas, parceiro, status, evidência, link, fallback, owner, próxima evidência necessária e data de revisão.
