...
## Entregável
Matriz de entidades + minutas de acordos em `99-archive/superado/01-blueprint-v1-submissao-superada/governanca-juridico/` + `01-work/pesquisa-e-confianca/documentos-oficiais/_controle/`, como insumos de Blueprint e Refinamento para revisão posterior.
