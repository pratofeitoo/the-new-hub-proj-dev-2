...
## Objetivo
Consolidar RACI v2 sem ambiguidade (1 A por atividade crítica) + direitos de decisão + tratamento de incidentes + sucessão fundador.

## Entregável
RACI v2 proposto em `HUB_Blueprint_Governanca_e_Juridico.md` + `00-project-control/registro-lacunas/lacunas/GOV-008.md`, para refinamento e revisão posterior.

## Dependências
- [[04-project-management/tarefas/P02-T06_RACI_Accountable_Unico|P02-T06]]
- [[04-project-management/tarefas/P04-T01_Arquitetura_Entidades|P04-T01]]

## Critério (G04.7)
Ambiguidades críticas identificadas e tratadas no artefato; decisões críticas e donos não-fundadores ficam explicitamente marcados para revisão posterior.
