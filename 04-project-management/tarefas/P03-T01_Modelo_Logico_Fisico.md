...
## Entregável
Proposta de diagramas + tabelas em `HUB_Blueprint_Dados_e_Inteligencia.md` + `01-work/refinamento-modelo-dados/`, para revisão posterior.
