---
title: TaskNotes NLP API
source: https://tasknotes.dev/nlp-api/
author:
published:
created: 2026-08-05
description: The NLP API parses natural-language task text and optionally creates a task.
tags:
  - clippings
...
For the full in-process API exposed at `tasknotes.api`, including task updates, time tracking, settings snapshots, and events, see [TaskNotes JavaScript API](https://tasknotes.dev/javascript-api/).
...
For task creation and updates from in-vault scripts or companion plugins, use the broader [TaskNotes JavaScript API](https://tasknotes.dev/javascript-api/).
