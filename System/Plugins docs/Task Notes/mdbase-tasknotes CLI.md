---
title: mdbase-tasknotes CLI
source: https://tasknotes.dev/mdbase-tasknotes-cli/
author:
published:
created: 2026-08-05
description: mdbase-tasknotes (mtn) is a standalone command-line tool for managing TaskNotes tasks directly on markdown files. It uses mdbase to read and write task files and tasknotes-nlp-c...
tags:
  - clippings
...
If you are looking for the built-in `obsidian tasknotes:*` commands exposed by the plugin itself, see [TaskNotes Obsidian CLI](https://tasknotes.dev/obsidian-cli/).
