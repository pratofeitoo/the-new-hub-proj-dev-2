...
source: https://tasknotes.dev/features/template-variables/
author:
published:
created: 2026-08-05
description:
...
| `{{titleSnake}}` | Title in snake\_case | Yes | Yes | `my_task` |
...
| `{{icsEventTitleSnake}}` | Event title in snake\_case | No | Yes |
