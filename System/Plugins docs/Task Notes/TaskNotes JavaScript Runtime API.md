---
title: TaskNotes JavaScript Runtime API
source: https://tasknotes.dev/javascript-api/
author:
published:
created: 2026-08-05
description: "TaskNotes exposes an in-process runtime API on the loaded Obsidian plugin instance:"
tags:
  - clippings
updated: 2026-08-05T03:41
---
```javascript
...
This is separate from the [HTTP API](https://tasknotes.dev/HTTP_API/). The runtime API does not start a server, does not use bearer-token authentication, and is only available inside the running Obsidian app.

For user-facing extensions built on this API, see [Companion Plugins](https://tasknotes.dev/companion-plugins/). For a concrete automation companion plugin, see [TaskNotes Workflows](https://tasknotes.dev/companion-plugins/tasknotes-workflows/).
...
See [NLP API](https://tasknotes.dev/nlp-api/) for HTTP endpoint details and parser behavior.
