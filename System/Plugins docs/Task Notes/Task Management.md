...
source: https://tasknotes.dev/features/task-management/
author:
published:
created: 2026-08-05
description: This page covers task creation, properties, projects, dependencies, recurring tasks, and reminders. For the underlying architecture, see Core Concepts.
tags:
  - clippings
updated: 2026-08-05T03:40
---
This page covers task creation, properties, projects, dependencies, recurring tasks, and reminders. For the underlying architecture, see [Core Concepts](https://tasknotes.dev/core-concepts/).
...
![Task creation modal](https://tasknotes.dev/assets/feature-task-modal-filled.png)
...
![Autosuggest projects with spaces](https://tasknotes.dev/assets/autosuggest_project_names_with_space.gif)

![Enhanced project autosuggester](https://tasknotes.dev/assets/enhanced-project-auto-suggester.gif)
...
![Status Auto-Suggestion](https://tasknotes.dev/assets/auto-suggest-status.gif)
...
For property types and examples, see [Core Concepts](https://tasknotes.dev/core-concepts/#yaml-frontmatter). For configuration options, see [Task Properties Settings](https://tasknotes.dev/settings/task-properties/).
...
For configuration details, see [Task Defaults](https://tasknotes.dev/settings/task-defaults/).  
For template variables, see [Template Variables Reference](https://tasknotes.dev/features/template-variables/).
...
For full behavior, examples, and edge cases, see [Recurring Tasks](https://tasknotes.dev/features/recurring-tasks/).
...
For full setup, data format, defaults, and UI behavior, see [Task Reminders](https://tasknotes.dev/features/reminders/).