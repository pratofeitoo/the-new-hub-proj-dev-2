...
> **Reconciliação (2026-09-05):** este simulador é um exercício histórico ilustrativo, **superado** pela aba `14_ROI` aprovada da planilha técnica — todos os valores `R$ 0`, ROI `0,0%`, aguardando baseline Monks. Nenhum número abaixo tem valor de decisão ou pode sustentar alegação externa.
