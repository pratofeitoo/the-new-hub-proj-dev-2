...
|---|---|---|
| [[01-blueprint/strategy/HUB_Project_Blueprint_Foundation]] | Fornece C.A.O.S., unidades, módulos, atores, limite de maturidade e princípios de evidência. | Este documento operacionaliza a fundação; decisões de estratégia aprovadas posteriormente substituem as premissas aqui. |
...
| [[00-project-control/gap-register/HUB_Project_Gap_Register]] e gaps individuais | Fornece condições de encerramento e rastreabilidade. | Manter [[STR-007]], [[PRD-005]], [[PRD-007]], [[GOV-008]] e [[LCH-002]] abertos até que evidências, aceitação do owner e condições de aprovação sejam atendidas. |
