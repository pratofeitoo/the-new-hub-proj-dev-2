---
title: TaskNotes HTTP API
source: https://tasknotes.dev/HTTP_API/
author:
published:
created: 2026-08-05
description: The TaskNotes HTTP API provides local HTTP access to tasks, time tracking, pomodoro, calendars, webhooks, and NLP parsing.
tags:
  - clippings
updated: 2026-08-05T03:49
---
...
- Browser CORS requests are allowed only from loopback origins such as `localhost`, `127.0.0.1`, and `[::1]`
...
- Set a token for any workflow where local browser pages, scripts, or other desktop apps are not fully trusted.
