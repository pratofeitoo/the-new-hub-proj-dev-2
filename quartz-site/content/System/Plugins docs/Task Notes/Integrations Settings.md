...
source: https://tasknotes.dev/settings/integrations/
author:
published:
created: 2026-08-05
description: These settings control the integration with other plugins and services, such as Bases and external calendars.
tags:
  - clippings
...
![Integrations Settings](https://tasknotes.dev/assets/settings-integrations.png)

## Bases

TaskNotes v4 uses Obsidian's Bases core plugin for its main views. For setup instructions, see [Core Concepts](https://tasknotes.dev/core-concepts/#bases-integration).
...
**Setup Guide**: See [Calendar Integration Setup](https://tasknotes.dev/calendar-setup/) for detailed instructions on creating OAuth credentials with Google Cloud Console and Azure Portal.
