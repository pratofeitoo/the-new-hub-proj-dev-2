---
title: Canvas Bases
source: https://tasknotes.dev/companion-plugins/canvas-bases/
author:
published:
created: 2026-08-05
description: Canvas Bases is the TaskNotes canvas companion plugin for Obsidian Bases and Canvas. It turns the current Bases result set into a canvas-style board, either as a live Bases layo...
tags:
  - clippings
updated: 2026-08-05T03:46
---
...
Canvas Bases reads TaskNotes through the [TaskNotes JavaScript Runtime API](https://tasknotes.dev/javascript-api/). It feature-detects API capabilities before using them, so the board can degrade cleanly when TaskNotes is unavailable or a capability is missing.
