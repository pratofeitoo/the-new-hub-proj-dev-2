---
title: Modal Fields Settings
source: https://tasknotes.dev/settings/modal-fields/
author:
published:
created: 2026-08-05
description: The Modal Fields tab lets you decide exactly which fields appear in the task creation and edit modals. Open Settings → TaskNotes → Modal Fields to manage the configuration.
tags:
  - clippings
...
![Modal Fields Settings](https://tasknotes.dev/assets/settings-modal-fields.png)
