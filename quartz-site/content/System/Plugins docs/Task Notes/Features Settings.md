...
source: https://tasknotes.dev/settings/features/
author:
published:
created: 2026-08-05
description: These settings allow you to enable, disable, and configure the various features of the plugin, such as inline tasks, natural language processing, the Pomodoro timer, and notific...
tags:
  - clippings
...
![Features Settings](https://tasknotes.dev/assets/settings-features.png)
...
Occurrence note behavior is configured per recurring task from the task context menu: open **Recurrence → Occurrence notes** to choose manual creation or automatic creation of the next materialized occurrence after completion. See [Recurring Tasks](https://tasknotes.dev/features/recurring-tasks/#materialized-occurrence-notes) for the workflow and storage model.
