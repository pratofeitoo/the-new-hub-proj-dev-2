---
title: Adopt TaskNotes in an existing vault
source: https://tasknotes.dev/getting-started/existing-vault/
author:
published:
created: 2026-08-05
...
Start with title, status, priority, due, scheduled, projects, contexts, and recurrence. Use the [property types reference](https://tasknotes.dev/settings/property-types-reference/) to check value shapes.
...
If the note is not recognized, use the [troubleshooting decision tree](https://tasknotes.dev/troubleshooting/#tasks-not-appearing-in-views).
