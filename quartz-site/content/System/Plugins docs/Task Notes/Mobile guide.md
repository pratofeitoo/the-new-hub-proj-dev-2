---
title: Mobile guide
source: https://tasknotes.dev/getting-started/mobile/
author:
published:
created: 2026-08-05
...
1. Install an Obsidian mobile version compatible with the current [TaskNotes requirement](https://tasknotes.dev/reference/compatibility/).
