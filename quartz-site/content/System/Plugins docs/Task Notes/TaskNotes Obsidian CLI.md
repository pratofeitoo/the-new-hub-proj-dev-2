---
title: TaskNotes Obsidian CLI
source: https://tasknotes.dev/obsidian-cli/
author:
published:
created: 2026-08-05
description: TaskNotes can register commands directly with the Obsidian desktop CLI. This is useful when Obsidian is already running and you want shell access to task creation, time tracking...
tags:
  - clippings
...
Use this page for the built-in `obsidian ...` commands exposed by the plugin itself. If you want a standalone terminal tool that works directly on Markdown files without Obsidian running, see [mdbase-tasknotes CLI](https://tasknotes.dev/mdbase-tasknotes-cli/).
...
Use [mdbase-tasknotes CLI](https://tasknotes.dev/mdbase-tasknotes-cli/) when:
