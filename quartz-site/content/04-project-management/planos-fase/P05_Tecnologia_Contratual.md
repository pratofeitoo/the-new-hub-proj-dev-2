...
- [`HUB_Blueprint_Arquitetura_Tecnologica.md`](file:///Users/paulorezende/Library/Mobile%20Documents/iCloud~md~obsidian/Documents/Work/WORK/HUB/Projects/2026/The%20New%20HUB%20dev-2/01-blueprint/tecnologia/HUB_Blueprint_Arquitetura_Tecnologica.md) + `01-blueprint/dados-inteligencia/modelo-indicadores/10_Integracoes/`
- Gaps `TEC-*`
...
|---|---|---|
| Arquitetura solução + estratégia ambientes | `01-blueprint/tecnologia/` | blueprint |
| Contratos integração + matriz system-of-record | `02-refinement/testes-experimentos/` ou `tecnologia/` | refining |
| Mapa identidade entre sistemas | mesmo + link para P03 | refining |
| Modelo capacidade técnica (custo/latência/volume) | `02-refinement/modelos-financeiros/` (insumo para P06) | refining |
| Threat model + matriz controles segurança | `02-refinement/refinamento-governanca/` | refining |
| SLOs + runbooks + plano recuperação | `01-blueprint/tecnologia/` + `02-refinement/testes-experimentos/` | refining |
| Processo release + runbook lançamento | `01-blueprint/visao-lancamento/` + `04-project-management/planos-fase/` | refining |
| Pacote revisão P05 | `03-approval/pacotes-revisao/P05-Tecnologia.md` | approval |
...
- [ ] **G05.4** — Baseline técnico (custo/latência/volume/rate-limit) publicado e integrado ao modelo financeiro P06 (**TEC-005; blocking: yes**). Otimizações avançadas ficam pós-MVP.
...
- [ ] **G05.7** — Processo release/rollback + ambientes + suporte aprovados (**TEC-007; blocking: yes**).
