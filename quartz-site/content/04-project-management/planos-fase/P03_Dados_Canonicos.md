...
| **DAT-010** | Fonte verdade autoritativa (origem vs corrigido) | validation · **blocking: yes** | Linhagem artefatos inequívoca antes de liberar P03 |
...
- [ ] **G03.B2** — Dicionário físico ~41 campos mapeado para entidades canônicas; contradições entre `abas-origem/` e `03-csv-corrigido/` resolvidas e registradas em `04-registro-correcoes/` (**DAT-010; blocking: yes**). Automação e cobertura adicional de fontes ficam pós-MVP.
