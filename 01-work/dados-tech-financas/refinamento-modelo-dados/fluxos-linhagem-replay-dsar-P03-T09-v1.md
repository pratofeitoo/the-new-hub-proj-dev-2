...
> **Depende de:** [[01-work/dados-tech-financas/refinamento-modelo-dados/modelo-logico-fisico-P03-T01-v1|P03-T01 v1]] — `canonical_id`; [[01-work/dados-tech-financas/refinamento-modelo-dados/envelope-evento-schema-P03-T03-v1|P03-T03 v1]] — envelope + replay; [[01-work/dados-tech-financas/refinamento-modelo-dados/matriz-dados-finalidade-P03-T08-v1|P03-T08 v1]] — retenção/DSAR.
...
Cada aresta registra `transformation, version, actor, time, quality, authorization, run_id` (ver [[01-work/dados-tech-financas/refinamento-modelo-dados/templates-linhagem-evidencias-P03-T06-v1|P03-T06 v1]]).
...
Regra: `consent.revoked` → `event consent.revoked` → `quarantine` derivados em ≤5 min (testado em [[01-work/dados-tech-financas/refinamento-modelo-dados/matriz-dados-finalidade-P03-T08-v1|P03-T08 v1]] §3).
