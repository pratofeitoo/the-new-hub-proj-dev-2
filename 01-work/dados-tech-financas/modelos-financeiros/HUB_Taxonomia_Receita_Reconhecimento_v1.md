...
> **Vocabulário financeiro congelado:** usar os estados **Potencial → Influenciado → Validado → Realizado**, ledger único, teto por população e haircut DAT-08 conforme [[01-work/dados-tech-financas/modelos-financeiros/HUB_Glossario_Financeiro_Congelado_v1|Glossário Financeiro Congelado v1]]. `14_ROI` permanece zerado até baseline Monks.
