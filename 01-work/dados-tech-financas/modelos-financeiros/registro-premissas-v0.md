...
related_notes:
  ...
  - "[[01-work/dados-tech-financas/refinamento-modelo-dados/modelo-indicadores/sintese-entre-abas/indicator-financial-consistency]]"
  - "[[01-work/dados-tech-financas/refinamento-modelo-dados/modelo-indicadores/sintese-entre-abas/sintese-entre-abas/README|Catálogo canônico P03]]"
...
- **P03-T05** → `01-work/dados-tech-financas/refinamento-modelo-dados/modelo-indicadores/sintese-entre-abas/` — 73 indicadores com fórmula/dimensão/owner. Toda premissa de *valor/resultado* deve apontar para um `indicador_id` canônico.
- **P05-T04** → `01-work/dados-tech-financas/modelos-financeiros/` (baseline M0–M2) — custo, latência, volume, rate-limit por integração. Toda premissa de *custo/capacidade* deve apontar para uma linha do baseline.

Sem esse duplo vínculo, qualquer ROI (ex.: `28,42%` ilustrativo do simulador) permanece **não auditável** — ver [[01-work/dados-tech-financas/refinamento-modelo-dados/modelo-indicadores/sintese-entre-abas/indicator-financial-consistency#6. Severidade e readiness|severidade crítica: soma de 6 alavancas sem ledger]].
...
> Fonte canônica: `01-work/dados-tech-financas/modelos-financeiros/` — tabela de baseline por integração (P05-T02 → P05-T04). Sem essa linha, P06-T01 não pode fechar `G05.4` e P07 não passa em `G07.4`.
