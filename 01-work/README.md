# 01 — Work: tudo que está em elaboração
...
> **Organização:** por domínio (`estrategia/`, `produto/`, `tecnologia/`, `dados-inteligencia/`, `modelo-negocio/`, `marca-mercado/`, `governanca-juridico/`, `operacoes/`, `visao-lancamento/`, `documentos-oficiais/`, refinamentos...).
...
4. `documentos-oficiais/` aqui é **modelo futuro / rascunho** — nada ali é oficial. Ver GOV-001.
