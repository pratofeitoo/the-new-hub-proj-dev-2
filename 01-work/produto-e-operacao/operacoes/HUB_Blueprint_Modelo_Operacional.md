...
|---|---|---|
| [[01-work/mercado-e-direcao/estrategia/HUB_Fundacao_Blueprint_Projeto]] | Fornece C.A.O.S., unidades, módulos, atores, limite de maturidade e princípios de evidência. | Este documento operacionaliza a fundação; decisões de estratégia aprovadas posteriormente substituem as premissas aqui. |
