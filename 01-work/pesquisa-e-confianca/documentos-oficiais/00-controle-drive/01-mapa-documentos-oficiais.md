...
> Mapa original esperado em `01-work/pesquisa-e-confianca/documentos-oficiais/_controle/HUB_Mapa_Documentos_Oficiais_v1.md` — não encontrado no momento da criação do vault (2026-09-02). Esta cópia foi reconstruída a partir da árvore detalhada de `HUB_Instrucao_Vault_Documentos_Oficiais.md §1` e deve ser reconciliada quando o mapa original for localizado.
