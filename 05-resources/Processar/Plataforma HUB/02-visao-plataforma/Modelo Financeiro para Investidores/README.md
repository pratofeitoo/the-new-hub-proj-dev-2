...
- `fontes/Modelo Financeiro.xlsx` — workbook com resumo executivo, premissas, custos, preços, projeção de cinco anos, unit economics, análises de sensibilidade, checks e fontes.
