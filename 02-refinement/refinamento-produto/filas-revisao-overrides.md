...
- Referência: [[01-blueprint/produto/HUB_Blueprint_Produto_e_Capacidades#5. Atividades conduzidas por humanos, assistidas e de automação futura|BP-002 §5]] e [[01-blueprint/operacoes/HUB_Blueprint_Modelo_Operacional#2. Responsabilidades por vendas, onboarding, diagnóstico, curadoria, matching, implementação, medição, suporte e escalonamento|BP-005 §2]]
