...
projects:
  ...
  - "[[02-refinement/refinamento-governanca/HUB_Instrucao_Vault_Documentos_Oficiais]]"
contexts:
  - "@juridico"
  - "@governanca"
timeEstimate: 480
...
**Fonte da verdade:**
- `GOV-MAP-001` → `01-08` (32 docs obrigatórios) → `[[02-refinement/refinamento-governanca/HUB_Mapa_Documentos_Oficiais_v1]]`
- `GOV-MAP-002` → `09-14` (27 docs não-obrigatórios mas requeridos) → `[[02-refinement/refinamento-governanca/HUB_Mapa_Documentos_Nao_Obrigatorios_v1]]`
- Instrução visual v2 → `[[02-refinement/refinamento-governanca/HUB_Instrucao_Vault_Documentos_Oficiais]]`
